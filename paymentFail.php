                ...
                <tr>
                    <td colspan="5">
                        <div class="form-group text-right">
                            ...
                            <input type="submit" name="backToCheckOut-submit" id="backToCheckOut-submit" tabindex="4" class="form-control btn btn-success" value="CheckOut">
                            <input type="submit" name="cancelOrder-submit" id="cancelOrder-submit" tabindex="4" class="form-control btn btn-primary" value="Home">          
                        </div>
                    </td>
               </tr>
               <tr>
